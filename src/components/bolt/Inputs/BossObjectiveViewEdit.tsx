...
// Hooks
import { useBossObjectiveForm } from "@/hooks/updateObjective/useBossUpdateObjectiveForm";
...
interface BossObjectiveFormProps {
 ...
 *
 * @param {BossObjectiveFormProps} props - The props for the ObjectiveForm component.
 ...
 */
export default function BossObjectiveForm({
  objective,
  classifications,
  progress,
}: BossObjectiveFormProps) {
  const {
    form,
    formConfig,
    isEditable,
    ...
    setIsEditable,
    updateCurrentValues,
  } = useBossObjectiveForm({ objective, progress: progress });
